  ...
  class ONI_Recon_Essentials_M412_Bison_IFV: OPTRE_M412_IFV_UNSC
  {
    faction="ONI_Recon_Faction";
    editorSubcategory = "ONI_Recon_Faction_IFV";
    side=1;
    ...
    crew="ONI_Recon_Essentials_Team_Leader";
    typicalCargo[]={"ONI_Recon_Essentials_Team_Leader"};
  };

  class ONI_Recon_Essentials_M413_Bison_MGS: OPTRE_M413_MGS_UNSC
  {
    faction="ONI_Recon_Faction";
    editorSubcategory = "ONI_Recon_Faction_IFV";
    side=1;
